...
class __TwigTemplate_67c39691d7c46e47145fb89b6dd39923 extends Template
{
    private $source;
    private $macros = [];
    ...
    <tr>
        ...
        if ( !twig_test_empty(((array_key_exists("idSite", $context)) ? (_twig_default_filter((isset($context["idSite"]) || array_key_exists("idSite", $context) ? $context["idSite"] : (function () { throw new RuntimeError('Variable "idSite" does not exist.', 25, $this->source); })()))) : ("")))) {
            ...
            if ( !twig_test_empty(((array_key_exists("websiteName", $context)) ? (_twig_default_filter((isset($context["websiteName"]) || array_key_exists("websiteName", $context) ? $context["websiteName"] : (function () { throw new RuntimeError('Variable "websiteName" does not exist.', 26, $this->source); })()))) : ("")))) {
                echo "title=\"";
                echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["Dashboard_TopLinkTooltip", (isset($context["websiteName"]) || array_key_exists("websiteName", $context) ? $context["websiteName"] : (function () { throw new RuntimeError('Variable "websiteName" does not exist.', 26, $this->source); })())]), "html", null, true);
                echo "\"";
            }
...
<div style=\"margin:0 20px 25px 20px;\">
", "@CoreHome/_htmlEmailHeader.twig", "/Users/alfonsorodriguezmadrid/Documents/copaEurope/poc/poc-matomo-nestjs/matomo/plugins/CoreHome/templates/_htmlEmailHeader.twig");
    }
}
