...
class __TwigTemplate_194acdd86bb88a237c101e9831bcc5b0 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <table cellspacing=\"0\" class=\"dataTable\">
        ...
        <tbody>";
            ...
            // line 15
            if (((isset($context["showingEmbeddedSubtable"]) || array_key_exists("showingEmbeddedSubtable", $context) ? $context["showingEmbeddedSubtable"] : (function () { throw new RuntimeError('Variable "showingEmbeddedSubtable" does not exist.', 15, $this->source); })()) && (twig_get_attribute($this->env, $this->source, (isset($context["dataTable"]) || array_key_exists("dataTable", $context) ? $context["dataTable"] : (function () { throw new RuntimeError('Variable "dataTable" does not exist.', 15, $this->source); })()), "getRowsCount", [], "method", false, false, false, 15) == 0))) {
                // line 16
                echo "            ";
...
($context["properties"] ?? null), "replace_row_with_subtable", [], "any", true, true, false, 34)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["properties"] ?? null), "replace_row_with_subtable", [], "any", false, false, false, 34), false)) : (false)));
                    ...
                    if ((isset($context["showRow"]) || array_key_exists("showRow", $context) ? $context["showRow"] : (function () { throw new RuntimeError('Variable "showRow" does not exist.', 36, $this->source); })())) {
                        ...
                        // line 38
                        echo "                    ";
                        if ( !call_user_func_array($this->env->getTest('false')->getCallable(), [twig_get_attribute($this->env, $this->source, $context["row"], "getMetadata", [0 => "segment"], "method", false, false, false, 38)])) {
                        ...
                        // line 39
                        echo "                    ";
                        if ( !call_user_func_array($this->env->getTest('false')->getCallable(), [twig_get_attribute($this->env, $this->source, $context["row"], "getMetadata", [0 => "url"], "method", false, false, false, 39)])) {
                            echo " data-url-label=\"";
                            echo call_user_func_array($this->env->getFilter('rawSafeDecoded')->getCallable(), [twig_get_attribute($this->env, $this->source, $context["row"], "getMetadata", [0 => "url"], "method", false, false, false, 39)]);
                            echo "\"";
                        }
                        // line 40
...
{% else %}
    ...
    {%- endif -%}
{% endif %}", "@CoreVisualizations/_dataTableViz_htmlTable.twig", "/Users/alfonsorodriguezmadrid/Documents/copaEurope/poc/poc-matomo-nestjs/matomo/plugins/CoreVisualizations/templates/_dataTableViz_htmlTable.twig");
    }
}
