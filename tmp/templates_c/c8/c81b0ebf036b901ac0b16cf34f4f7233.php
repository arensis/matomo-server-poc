...
class __TwigTemplate_866dfc7c7c595385d0984dbf2527253a extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
            ...
            // line 6
            echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["CoreAdminHome_NTrackingFailures", (isset($context["numFailures"]) || array_key_exists("numFailures", $context) ? $context["numFailures"] : (function () { throw new RuntimeError('Variable "numFailures" does not exist.', 6, $this->source); })())]), "html", null, true);
            echo "</span>
        </p>
        <p>
            <a href=\"";
    ...
    {% endif %}
</div>", "@CoreAdminHome/getTrackingFailures.twig", "/Users/alfonsorodriguezmadrid/Documents/copaEurope/poc/poc-matomo-nestjs/matomo/plugins/CoreAdminHome/templates/getTrackingFailures.twig");
    }
}
