...
/* layout.twig */
class __TwigTemplate_3626c373cece2fb0d65d63d365af17b5 extends Template
{
    private $source;
    private $macros = [];
...
<html id=\"ng-app\" ";
    ...
    <body id=\"";
        ...
        ";
        // line 34
        echo call_user_func_array($this->env->getFunction('postEvent')->getCallable(), ["Template.bodyTop"]);
        echo "
    ...
    ";
        ...
        ";
        // line 57
        echo call_user_func_array($this->env->getFunction('postEvent')->getCallable(), ["Template.bodyBottom"]);
        echo "
    </body>
</html>
";
...
", "layout.twig", "/Users/alfonsorodriguezmadrid/Documents/copaEurope/poc/poc-matomo-nestjs/matomo/plugins/Morpheus/templates/layout.twig");
    }
}
