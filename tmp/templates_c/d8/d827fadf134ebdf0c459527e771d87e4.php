...
class __TwigTemplate_196b90e00d706fb293b997e9edf93a1b extends Template
{
    private $source;
    private $macros = [];
    ...
    <div style=\"clear:both;width:800px;\">
        ";
            // line 17
            echo call_user_func_array($this->env->getFilter('notification')->getCallable(), [(isset($context["invalidHostText"]) || array_key_exists("invalidHostText", $context) ? $context["invalidHostText"] : (function () { throw new RuntimeError('Variable "invalidHostText" does not exist.', 17, $this->source); })()), ["noclear" => true, "raw" => true, "context" => "warning"]]);
            echo "
    </div>
...
", "@CoreHome/_warningInvalidHost.twig", "/Users/alfonsorodriguezmadrid/Documents/copaEurope/poc/poc-matomo-nestjs/matomo/plugins/CoreHome/templates/_warningInvalidHost.twig");
    }
}
