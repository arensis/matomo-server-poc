...
class __TwigTemplate_cdb119807563be4d6d2e3d87a31d548e extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if ( !twig_test_empty(((array_key_exists("unsubscribeLink", $context)) ? (_twig_default_filter((isset($context["unsubscribeLink"]) || array_key_exists("unsubscribeLink", $context) ? $context["unsubscribeLink"] : (function () { throw new RuntimeError('Variable "unsubscribeLink" does not exist.', 21, $this->source); })()))) : ("")))) {
            ...
            echo "'>";
            echo call_user_func_array($this->env->getFilter('translate')->getCallable(), ["ScheduledReports_UnsubscribeFooter", (isset($context["unsubLink"]) || array_key_exists("unsubLink", $context) ? $context["unsubLink"] : (function () { throw new RuntimeError('Variable "unsubLink" does not exist.', 23, $this->source); })())]);
            echo ".</p>
";
        }
        // line 25
...
", "@CoreHome/_htmlEmailFooter.twig", "/Users/alfonsorodriguezmadrid/Documents/copaEurope/poc/poc-matomo-nestjs/matomo/plugins/CoreHome/templates/_htmlEmailFooter.twig");
    }
}
