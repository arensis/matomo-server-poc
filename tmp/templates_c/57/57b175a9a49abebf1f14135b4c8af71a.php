...
class __TwigTemplate_afaf8ec7937fa6fe194499ed7a25fafa extends Template
{
    private $source;
    private $macros = [];
    ...
    <span id=\"piwik-worth\">";
        // line 12
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["CoreHome_SupportUsOn"]), "html", null, true);
        echo "</span>
    ...
    <p style=\"margin-top: 1em;\">
        ";
        // line 23
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["CoreHome_YourDonationWillHelp"]), "html", null, true);
        echo "
        <br><br>
        <strong>";
        // line 25
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["CoreHome_ThanksFromAllOfUs"]), "html", null, true);
        echo "</strong>
    </p>
...
", "@CoreHome/_donate.twig", "/Users/alfonsorodriguezmadrid/Documents/copaEurope/poc/poc-matomo-nestjs/matomo/plugins/CoreHome/templates/_donate.twig");
    }
}
