...
/* @CoreHome/_menu.twig */
class __TwigTemplate_892146d67d9bac3133313571fbd3fd77 extends Template
{
    private $source;
    private $macros = [];
                    ...
                    foreach ($context['_seq'] as $context["name"] => $context["urlParameters"]) {
                        ...
                        if ((twig_slice($this->env, $context["name"], 0, 1) != "_")) {
                            ...
                            if (twig_get_attribute($this->env, $this->source, $context["urlParameters"], "_url", [], "any", false, false, false, 35)) {
                                // line 36
                                echo "                                                href=\"index.php?";
                                echo \Piwik\piwik_escape_filter($this->env, twig_slice($this->env, call_user_func_array($this->env->getFilter('urlRewriteWithParameters')->getCallable(), [twig_get_attribute($this->env, $this->source, $context["urlParameters"], "_url", [], "any", false, false, false, 36)]), 1), "html", null, true);
                                echo "\"
                                            ";
                            }
                            // line 37
                    ...
                    foreach ($context['_seq'] as $context["name"] => $context["urlParameters"]) {
                        ...
                        if ((twig_slice($this->env, $context["name"], 0, 1) != "_")) {
                            ...
                            echo "\" target=\"_self\"
                                               href=\"index.php?";
                            // line 73
                            echo \Piwik\piwik_escape_filter($this->env, twig_slice($this->env, call_user_func_array($this->env->getFilter('urlRewriteWithParameters')->getCallable(), [twig_get_attribute($this->env, $this->source, $context["urlParameters"], "_url", [], "any", false, false, false, 73)]), 1), "html", null, true);
                            echo "\">";
                            echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), [$context["name"]]), "html", null, true);
                            echo "</a>
                                        </li>
...
{% endmacro %}
", "@CoreHome/_menu.twig", "/Users/alfonsorodriguezmadrid/Documents/copaEurope/poc/poc-matomo-nestjs/matomo/plugins/CoreHome/templates/_menu.twig");
    }
}
