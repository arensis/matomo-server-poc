...
class __TwigTemplate_f97398fe800b0bf745044705a8c1cf57 extends Template
{
    private $source;
    private $macros = [];
...
array_key_exists("showPluginArchiveDisabled", $context) && (isset($context["showPluginArchiveDisabled"]) || array_key_exists("showPluginArchiveDisabled", $context) ? $context["showPluginArchiveDisabled"] : (function () { throw new RuntimeError('Variable "showPluginArchiveDisabled" does not exist.', 62, $this->source); })()))) {
                        // line 63
                        echo "                    ";
                        echo call_user_func_array($this->env->getFilter('translate')->getCallable(), ["CoreHome_DataForThisReportHasBeenDisabled", (("<a target=\"_blank\" href=\"" . "https://matomo.org/faq/how-to-disable-archiving-the-segment-reports-for-specific-plugins") . "\">"), "</a>"]);
                        echo "
                ";
...
{%- endif %}
", "@CoreHome/_dataTable.twig", "/Users/alfonsorodriguezmadrid/Documents/copaEurope/poc/poc-matomo-nestjs/matomo/plugins/CoreHome/templates/_dataTable.twig");
    }
}
