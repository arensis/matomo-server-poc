...
class __TwigTemplate_efabdc7ce517c8f5a9866f675b1c627e extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"ui-confirm\" id=\"removeDashboardConfirm\">
        ...
        // line 105
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["Dashboard_NotUndo", (isset($context["resetDashboard"]) || array_key_exists("resetDashboard", $context) ? $context["resetDashboard"] : (function () { throw new RuntimeError('Variable "resetDashboard" does not exist.', 105, $this->source); })())]), "html", null, true);
        echo "</div>
        <input role=\"yes\" type=\"button\" value=\"";
        // line 106
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["General_Yes"]), "html", null, true);
...
", "@Dashboard/embeddedIndex.twig", "/Users/alfonsorodriguezmadrid/Documents/copaEurope/poc/poc-matomo-nestjs/matomo/plugins/Dashboard/templates/embeddedIndex.twig");
    }
}
