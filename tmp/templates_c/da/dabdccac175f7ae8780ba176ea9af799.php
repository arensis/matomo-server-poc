...
class __TwigTemplate_9ef3eda720b8f5b0c9dc8ebbb0c202bf extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
            ...
            if (twig_test_empty(((array_key_exists("rowPercentage", $context)) ? (_twig_default_filter((isset($context["rowPercentage"]) || array_key_exists("rowPercentage", $context) ? $context["rowPercentage"] : (function () { throw new RuntimeError('Variable "rowPercentage" does not exist.', 10, $this->source); })()))) : ("")))) {
                ...
                if ((twig_get_attribute($this->env, $this->source, (isset($context["row"]) || array_key_exists("row", $context) ? $context["row"] : (function () { throw new RuntimeError('Variable "row" does not exist.', 11, $this->source); })()), "getMetadata", [0 => ((isset($context["column"]) || array_key_exists("column", $context) ? $context["column"] : (function () { throw new RuntimeError('Variable "column" does not exist.', 11, $this->source); })()) . "_row_percentage")], "method", false, false, false, 11) != false)) {
                    ...
                    // line 13
                    echo "        ";
                } elseif ((call_user_func_array($this->env->getTest('numeric')->getCallable(), [((twig_get_attribute($this->env, $this->source, ($context["row"] ?? null), "getColumn", [0 => (isset($context["column"]) || array_key_exists("column", $context) ? $context["column"] : (function () { throw new RuntimeError('Variable "column" does not exist.', 13, $this->source); })())], "method", true, true, false, 13)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["row"] ?? null), "getColumn", [0 => (isset($context["column"]) || array_key_exists("column", $context) ? $context["column"] : (function () { throw new RuntimeError('Variable "column" does not exist.', 13, $this->source); })())], "method", false, false, false, 13), 0)) : (0))]) && call_user_func_array($this->env->getTest('numeric')->getCallable(), [(isset($context["reportTotal"]) || array_key_exists("reportTotal", $context) ? $context["reportTotal"] : (function () { throw new RuntimeError('Variable "reportTotal" does not exist.', 13, $this->source); })())]))) {
                    // line 14
                    echo "            ";
                    $context["rowPercentage"] = call_user_func_array($this->env->getFilter('percentage')->getCallable(), [twig_get_attribute($this->env, $this->source, (isset($context["row"]) || array_key_exists("row", $context) ? $context["row"] : (function () { throw new RuntimeError('Variable "row" does not exist.', 14, $this->source); })()), "getColumn", [0 => (isset($context["column"]) || array_key_exists("column", $context) ? $context["column"] : (function () { throw new RuntimeError('Variable "column" does not exist.', 14, $this->source); })())], "method", false, false, false, 14), (isset($context["reportTotal"]) || array_key_exists("reportTotal", $context) ? $context["reportTotal"] : (function () { throw new RuntimeError('Variable "reportTotal" does not exist.', 14, $this->source); })()), 1]);
                    // line 15
                    echo "        ";
                } else {
                    // line 16
    ...
    ";
            ...
            if ( !twig_test_empty(((array_key_exists("totalPercentage", $context)) ? (_twig_default_filter((isset($context["totalPercentage"]) || array_key_exists("totalPercentage", $context) ? $context["totalPercentage"] : (function () { throw new RuntimeError('Variable "totalPercentage" does not exist.', 32, $this->source); })()))) : ("")))) {
                // line 33
                echo "        ";
                $context["totalRatioTooltip"] = call_user_func_array($this->env->getFilter('translate')->getCallable(), ["General_TotalRatioTooltip", (isset($context["totalPercentage"]) || array_key_exists("totalPercentage", $context) ? $context["totalPercentage"] : (function () { throw new RuntimeError('Variable "totalPercentage" does not exist.', 33, $this->source); })()), call_user_func_array($this->env->getFilter('number')->getCallable(), [(isset($context["siteTotal"]) || array_key_exists("siteTotal", $context) ? $context["siteTotal"] : (function () { throw new RuntimeError('Variable "siteTotal" does not exist.', 33, $this->source); })()), 2, 0]), ((((isset($context["column"]) || array_key_exists("column", $context) ? $context["column"] : (function () { throw new RuntimeError('Variable "column" does not exist.', 33, $this->source); })()) == "nb_visits")) ? (call_user_func_array($this->env->getFilter('translate')->getCallable(), ["General_ColumnNbVisits"])) : ((isset($context["metricTitle"]) || array_key_exists("metricTitle", $context) ? $context["metricTitle"] : (function () { throw new RuntimeError('Variable "metricTitle" does not exist.', 33, $this->source); })()))), (isset($context["periodTitlePretty"]) || array_key_exists("periodTitlePretty", $context) ? $context["periodTitlePretty"] : (function () { throw new RuntimeError('Variable "periodTitlePretty" does not exist.', 33, $this->source); })())]);
                // line 34
                echo "    ";
            } else {
                // line 35
    ...
    <span class=\"ratio\"
          title=\"";
            // line 39
            echo call_user_func_array($this->env->getFilter('rawSafeDecoded')->getCallable(), [(isset($context["reportRatioTooltip"]) || array_key_exists("reportRatioTooltip", $context) ? $context["reportRatioTooltip"] : (function () { throw new RuntimeError('Variable "reportRatioTooltip" does not exist.', 39, $this->source); })())]);
            echo " ";
            echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('rawSafeDecoded')->getCallable(), [(isset($context["totalRatioTooltip"]) || array_key_exists("totalRatioTooltip", $context) ? $context["totalRatioTooltip"] : (function () { throw new RuntimeError('Variable "totalRatioTooltip" does not exist.', 39, $this->source); })())]), "html_attr");
            if ( !twig_test_empty(((array_key_exists("tooltipSuffix", $context)) ? (_twig_default_filter((isset($context["tooltipSuffix"]) || array_key_exists("tooltipSuffix", $context) ? $context["tooltipSuffix"] : (function () { throw new RuntimeError('Variable "tooltipSuffix" does not exist.', 39, $this->source); })()))) : ("")))) {
                echo "<br/><br/> ";
                echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('rawSafeDecoded')->getCallable(), [(isset($context["tooltipSuffix"]) || array_key_exists("tooltipSuffix", $context) ? $context["tooltipSuffix"] : (function () { throw new RuntimeError('Variable "tooltipSuffix" does not exist.', 39, $this->source); })())]), "html_attr");
            }
            echo "\"
    >&nbsp;";
            // line 40
...
{%- endif %}
", "@CoreVisualizations/_dataTableViz_htmlTable_ratio.twig", "/Users/alfonsorodriguezmadrid/Documents/copaEurope/poc/poc-matomo-nestjs/matomo/plugins/CoreVisualizations/templates/_dataTableViz_htmlTable_ratio.twig");
    }
}
