...
class __TwigTemplate_7eab9e040bff530f48b03519e01c65d3 extends Template
{
    private $source;
    private $macros = [];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            ...
            if ( !twig_test_empty($context["item"])) {
                ...
                if (twig_get_attribute($this->env, $this->source, $context["item"], "getUrlParams", [], "any", false, false, false, 7)) {
                    // line 8
                    echo "<a href=\"";
                    echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFunction('linkTo')->getCallable(), [twig_get_attribute($this->env, $this->source, $context["item"], "getUrlParams", [], "any", false, false, false, 8)]), "html", null, true);
    ...
    {% endfor %}
    <br />
</div>", "@CoreHome/getSystemSummary.twig", "/Users/alfonsorodriguezmadrid/Documents/copaEurope/poc/poc-matomo-nestjs/matomo/plugins/CoreHome/templates/getSystemSummary.twig");
    }
}
