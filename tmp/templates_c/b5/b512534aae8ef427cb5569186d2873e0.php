...
class __TwigTemplate_b9b62f5f90fd31a02fbf25f447fbea5a extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
        ...
        // line 4
        echo call_user_func_array($this->env->getFilter('translate')->getCallable(), ["Marketplace_TrialHints", "<a style='color:#5bb75b;text-decoration: underline;' href='https://shop.matomo.org/free-trial/' target='_blank' rel='nofollo'>", "</a>"]);
        echo "</h3>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["plugin"]) {
            ...
            if ((twig_get_attribute($this->env, $this->source, $context["plugin"], "specialOffer", [], "any", false, false, false, 11) != "")) {
                ...
                echo "                <span class=\"pluginSubtitle\">
                    <span>";
                // line 13
                echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["Marketplace_SpecialOffer"]), "html", null, true);
                echo ":</span> ";
...
</div>", "@Marketplace/getPremiumFeatures.twig", "/Users/alfonsorodriguezmadrid/Documents/copaEurope/poc/poc-matomo-nestjs/matomo/plugins/Marketplace/templates/getPremiumFeatures.twig");
    }
}
