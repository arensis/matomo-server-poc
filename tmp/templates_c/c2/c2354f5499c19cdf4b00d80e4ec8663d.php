...
class __TwigTemplate_da52990799485b13f6ad5492ee9e5b89 extends Template
{
    private $source;
    private $macros = [];
...
(isset($context["isAnonymousUser"]) || array_key_exists("isAnonymousUser", $context) ? $context["isAnonymousUser"] : (function () { throw new RuntimeError('Variable "isAnonymousUser" does not exist.', 124, $this->source); })())) {
        ...
        ";
            ...
            echo "            <p>
                ...
                <a href=\"mailto:";
            // line 131
            echo \Piwik\piwik_escape_filter($this->env, \Piwik\piwik_escape_filter($this->env, (isset($context["contactEmail"]) || array_key_exists("contactEmail", $context) ? $context["contactEmail"] : (function () { throw new RuntimeError('Variable "contactEmail" does not exist.', 131, $this->source); })()), "url"), "html", null, true);
            echo "?subject=";
...
", "@CorePluginsAdmin/safemode.twig", "/Users/alfonsorodriguezmadrid/Documents/copaEurope/poc/poc-matomo-nestjs/matomo/plugins/CorePluginsAdmin/templates/safemode.twig");
    }
}
